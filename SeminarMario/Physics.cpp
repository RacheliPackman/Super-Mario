...
///check if bottom of one collision mask meet with top of other  collision mask
...
bool FixedWidgetPhysics::checkCollisionBottom(std::shared_ptr<IPhysicsComponent> const& other) const
{
	return checkPixelLevelCollisionBottom(this, other);
}
...
bool ConstVelocityPhysics::checkCollisionBottom(std::shared_ptr<IPhysicsComponent> const& other) const
{
	return checkPixelLevelCollisionBottom(this, other);
}
...
JumpPhysics::JumpPhysics(int horizontalVelocity, int initialVerticalVelocity, int gravity , int bottom)
	:_gravity(gravity), _initialThrowVelocity(horizontalVelocity, -initialVerticalVelocity)
													,_currVelocity(_initialThrowVelocity),_bottom(bottom)
{
...
bool JumpPhysics::checkCollisionBottom(std::shared_ptr<IPhysicsComponent> const& other) const
{
	return checkPixelLevelCollisionBottom(this, other);
}
...
bool NonCollidingPhysicsDecorator::checkCollisionBottom(std::shared_ptr<IPhysicsComponent> const& other) const
{
	return false;
}
...
bool BoundedPhysicsDecorator::checkCollisionBottom(std::shared_ptr<IPhysicsComponent> const& other) const
{
	return checkPixelLevelCollisionBottom(this, other);
}
